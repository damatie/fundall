      ...
      <React.Fragment>
        <div>
          <Dialog open={open} onClose={handleClose} fullWidth={true} maxWidth={'sm'} aria-labelledby="form-dialog-title">
            <DialogTitle id="form-dialog-title">Detail of Opening</DialogTitle>
            <DialogContent>
              <table className={clsx(classes.table, 'w-full text-justify')}>
                ...
                <Grid container className="items-center w-full pt-20" justify="center" alignItems="center">
                  <Button
                    ...
                    onClick={ev => {props.handleReject(ev, selected.training.id); handleClose(); }} 
                  >
                    View full details
                  </Button>
                  &nbsp;
                  <Button
                    ...
                    onClick={ev => {props.handleApprove(ev, selected.training.id); handleClose(); }} 
                  >
                    Assign a recruiter
                  </Button>
                </Grid>
          ...
          <div className="flex flex-2 items-center">
            <FormControl className="">
              <Select value={filter} onChange={ev => handleFilter(ev)} displayEmpty name="filter" className="">
                ...
                <MenuItem value="assigned">Recruiter assigned</MenuItem>
                <MenuItem value="notAssigned">Recruiter not assigned</MenuItem>
              </Select>
            </FormControl>
          </div>
        </div>
						...
						{_.orderBy(
								...
								return (
									...
									>
										...
										<TableCell className="text-center">{n.employeeStatus}</TableCell>
										<TableCell className="text-center">{n.department.departmentName}</TableCell>
										<TableCell className="text-center">{n.urgency}</TableCell>
                    <TableCell className="text-center">
