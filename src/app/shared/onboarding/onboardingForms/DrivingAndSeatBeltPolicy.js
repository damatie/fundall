...
const DrivingAndSeatBeltPolicy = () => {
  ...
  return (
    ...
    >
      <div className={classes.title}>
        <h1>Driving And Seat Belt Policy</h1>
      </div>
      <div className={classes.texts}>
        <p>
          I have read and fully understand the SpringRock Driving and Seat Belt
          policy attached herein. In addition, l have asked all questions I have
          concerning the policy and these have been clarified by my manager.
        </p>
        <p>
        ...
        <p>
          ...
          violations of a policy will result in disciplinary action up and
          including dismissal.
        </p>
      </div>
...
export default DrivingAndSeatBeltPolicy;
