...
const PerformanceAppraisalConfig = {
	...
	routes: [
		...
		{
			path: '/performance_appraisal/kpoList/KpoQuarterlyReview',
			component: React.lazy(() => import('./KPOlist/KpoQuarterlyReview'))
		},
		{
		...
		{
			path: '/performance_appraisal/promotionalKpodetail',
			component: React.lazy(() => import('./KPOlist/PromotionalEmployeeKpoDetail'))
		}
	]
};
