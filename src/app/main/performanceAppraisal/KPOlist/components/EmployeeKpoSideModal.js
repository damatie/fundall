...
const EmployeeKpoSideModal = ({ customHook }) => {
	const {
		handleGetDepartment,
		getEmployeesByRole,
		handleCloseModal,
	...
	const { entities, departments } = useSelector(state => state.kpo);
	...
	return (
		<SharedModal title="Create KPO" open={open} handleClose={handleCloseModal}>
...
export default EmployeeKpoSideModal;
