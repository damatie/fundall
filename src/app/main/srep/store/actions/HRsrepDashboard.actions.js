				...
				if (data.success && data.data) {
					...
					srep =  data.data.map(srep => {
						...
						return {
							...
							status: srep.status,
							entityId: (srep.employee) ? (srep.employee.entityId ? srep.employee.entityId : 'null') : 'null',
							entity: (srep.employee) ? (srep.employee.entityName ? srep.employee.entityName : 'null') : 'null',
							departmentId: (srep.employee) ? (srep.employee.departmentId ? srep.employee.departmentId : 'null') : 'null',
							department: (srep.employee) ? (srep.employee.departmentName ? srep.employee.departmentName : 'null') : 'null',
