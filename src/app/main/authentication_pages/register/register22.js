...
const Register = () => {
  ...
  const handleSubmitClicked = (event) => {
    console.log("Submit Click: ", event.target.value);
    setClicked(true);
  };


  const onSubmit = async () => {
    const form = { ...getValues(), contactNumber, phoneNumber, industry, minNoOfEmployees, maxNoOfEmployees }
    ...
    <Card className={classes.root}>
        ...
        <Grid container spacing={3} justify='space-between' align='center' style={{ marginBottom: '3rem'}}>
            ...
            <Grid container spacing={3} justify='center' align='center'>
                <Button variant="contained" type='submit' color="primary" onClick={() =>  handleSubmitClicked}>
                    Submit 
                </Button>
            </Grid>
        </form>
