...
// 			setImageName((post) ? post.images[0].url : '');
...
// 				<ProgressBtn onClick={handleSubmit} loading={loading} content="Edit Blog Post" />
// 			</Grid>
...
// 							</Button>
//               { !names === true
//                 ? <img src={imageName} style={{width: 64}} />
...
// export default withReducer('AddBlogPost', reducer)(UpdateBlogPost);
