...
const EducationalQualificationCard = ({ educationalQualificationDetails, customHook, index, isUpdate  }) => {
        ...
        <div className={` ${classes.mainCard}`}>
            ...
            <div className={` ${classes.firstRow}`}>
                <div className={` ${classes.rowItemFirstRow}`}>
                    ...
                    <p className={` ${classes.rowItemContent}`}>{educationalQualificationDetails.school}</p>
                </div>
                <div className={` ${classes.rowItemFirstRow}`}>
            ...
            <div className={` ${classes.row}`}>
                <div className={` ${classes.rowItem}`}>
                    ...
                    <p className={` ${classes.rowItemContent}`}>{moment(educationalQualificationDetails.startYear).format("DD/MM/YYYY")}</p>
                </div>
                <div className={` ${classes.rowItem}`}>
                    <p className={` ${classes.rowItemLabel}`}>End Year</p>
                    <p className={` ${classes.rowItemContent}`}>{moment(educationalQualificationDetails.endYear).format("DD/MM/YYYY")}</p>
                </div>
            </div>
        </div>
    )
