...
import SpouseAndDependantCard from './SpouseAndDependantCard';
    ...
    return (
        <>
            ...
            <div className={` ${classes.shownOnScreen}`}>
                {
                    showOnScreen && (
                        formDetails.map((spouseAndDependant, index) => (
                            <SpouseAndDependantCard key={index} spouseAndDependant={spouseAndDependant} />
                        ))
                    )
                }
            </div>
            <CenterModal open={openModal} handleClose={() => setOpenModal(false)} title="Spouse & Dependent" hideCloseIcon={true} borderRadius={true} spacedAppBarHeight={true} largeWidth={true}>
                {
...
export default SpouseAndDependant
