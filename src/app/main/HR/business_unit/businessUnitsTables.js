...
function BusinessUnitsTable(props) {
	const dispatch = useDispatch();
	const businessUnits = useSelector(({ businessUnits }) => businessUnits.businessUnits.data);
	const searchText = useSelector(({ businessUnits }) => businessUnits.businessUnits.searchText);

	const [selected, setSelected] = useState([]);
	const [data, setData] = useState(businessUnits);
...
export default withRouter(BusinessUnitsTable);
