...
withReducer('roles', rolesReducer)(EmployeeOld);
withReducer('entity', entityReducer)(EmployeeOld);
withReducer('department', departmentReducer)(EmployeeOld);
export default withReducer('employees', reducer)(EmployeeOld);
